...
var adoptStyles = (renderRoot, styles61) => {
  if (supportsAdoptingStyleSheets) {
    renderRoot.adoptedStyleSheets = styles61.map((s) => s instanceof CSSStyleSheet ? s : s.styleSheet);
  } else {
    for (const s of styles61) {
...
var ReactiveElement = class extends HTMLElement {
   ...
   * @category styles
   */
  static finalizeStyles(styles61) {
    const elementStyles = [];
    if (Array.isArray(styles61)) {
      const set = new Set(styles61.flat(Infinity).reverse());
      for (const s of set) {
        elementStyles.unshift(getCompatibleStyle(s));
      }
    } else if (styles61 !== void 0) {
      elementStyles.push(getCompatibleStyle(styles61));
    }
  ...
  __initialize() {
    ...
    this.requestUpdate();
    (_a10 = this.constructor._initializers) == null ? void 0 : _a10.forEach((i) => i(this));
  }
  /**
  ...
  addController(controller) {
    ...
    if (this.renderRoot !== void 0 && this.isConnected) {
      (_a10 = controller.hostConnected) == null ? void 0 : _a10.call(controller);
    }
  }
  /**
  ...
  removeController(controller) {
    var _a10;
    (_a10 = this.__controllers) == null ? void 0 : _a10.delete(controller);
  }
  /**
  ...
  connectedCallback() {
    ...
    (_a10 = this.__controllers) == null ? void 0 : _a10.forEach((c) => {
      var _a11;
      return (_a11 = c.hostConnected) == null ? void 0 : _a11.call(c);
    });
  }
  /**
  ...
  disconnectedCallback() {
    ...
    (_a10 = this.__controllers) == null ? void 0 : _a10.forEach((c) => {
      var _a11;
      return (_a11 = c.hostDisconnected) == null ? void 0 : _a11.call(c);
    });
  }
  /**
  ...
  __propertyToAttribute(name, value) {
    ...
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a10 = options.converter) == null ? void 0 : _a10.toAttribute) !== void 0 ? options.converter : defaultConverter;
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      ...
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a10 = options.converter) == null ? void 0 : _a10.fromAttribute) !== void 0 ? options.converter : defaultConverter;
  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_a10 = this.__controllers) == null ? void 0 : _a10.forEach((c) => {
          var _a11;
          return (_a11 = c.hostUpdate) == null ? void 0 : _a11.call(c);
        });
  ...
  _$didUpdate(changedProperties) {
    ...
    (_a10 = this.__controllers) == null ? void 0 : _a10.forEach((c) => {
      var _a11;
      return (_a11 = c.hostUpdated) == null ? void 0 : _a11.call(c);
    });
    if (!this.hasUpdated) {
...
function query(selector, cache) {
  return (protoOrTarget, nameOrContext, descriptor) => {
    const doQuery = (el) => {
      var _a10;
      const result = ((_a10 = el.renderRoot) == null ? void 0 : _a10.querySelector(selector)) ?? null;
  ...
  return (obj, name) => {
    return desc(obj, name, {
      async get() {
        ...
        return ((_a10 = this.renderRoot) == null ? void 0 : _a10.querySelector(selector)) ?? null;
      }
    });
  };
}
...
function queryAssignedElements(options) {
  return (obj, name) => {
    ...
    return desc(obj, name, {
      get() {
        var _a10;
        const slotEl = (_a10 = this.renderRoot) == null ? void 0 : _a10.querySelector(slotSelector);
...
function resolveDirective(part, value, parent = part, attributeIndex) {
  ...
  let currentDirective = attributeIndex !== void 0 ? (_a10 = parent.__directives) == null ? void 0 : _a10[attributeIndex] : parent.__directive;
...
var ChildPart = class _ChildPart {
  ...
  get _$isConnected() {
    var _a10;
    return ((_a10 = this._$parent) == null ? void 0 : _a10._$isConnected) ?? this.__isConnected;
  }
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive(value)) {
      ...
      if (DEV_MODE4 && ((_a10 = this.options) == null ? void 0 : _a10.host) === value) {
  ...
  _commitNode(value) {
    ...
    if (this._$committedValue !== value) {
      ...
      if (ENABLE_EXTRA_SECURITY_HOOKS && sanitizerFactoryInternal !== noopSanitizer) {
        const parentNodeName = (_a10 = this._$startNode.parentNode) == null ? void 0 : _a10.nodeName;
  ...
  _commitTemplateResult(result) {
    ...
    if (((_a10 = this._$committedValue) == null ? void 0 : _a10._$template) === template) {
      debugLogEvent2 && debugLogEvent2({
  ...
  _$clear(start = wrap(this._$startNode).nextSibling, from) {
    var _a10;
    (_a10 = this._$notifyConnectionChanged) == null ? void 0 : _a10.call(this, false, true, from);
  ...
  setConnected(isConnected) {
    ...
    if (this._$parent === void 0) {
      ...
      (_a10 = this._$notifyConnectionChanged) == null ? void 0 : _a10.call(this, isConnected);
    } else if (DEV_MODE4) {
...
var EventPart = class extends AttributePart {
  ...
  handleEvent(event) {
    ...
    if (typeof this._$committedValue === "function") {
      this._$committedValue.call(((_a10 = this.options) == null ? void 0 : _a10.host) ?? this.element, event);
    } else {
...
var LitElement = class extends ReactiveElement {
  ...
  createRenderRoot() {
    ...
    (_a10 = this.renderOptions).renderBefore ?? (_a10.renderBefore = renderRoot.firstChild);
    return renderRoot;
  }
  /**
   * Updates the element. This method reflects property values to attributes
  ...
  connectedCallback() {
    var _a10;
    super.connectedCallback();
    (_a10 = this.__childPart) == null ? void 0 : _a10.setConnected(true);
  }
  /**
  ...
  disconnectedCallback() {
    var _a10;
    super.disconnectedCallback();
    (_a10 = this.__childPart) == null ? void 0 : _a10.setConnected(false);
  }
  /**
...
if (!isServer) {
  FOR_ATTRIBUTE_OBSERVER = new MutationObserver((records) => {
    ...
    for (const record of records) {
      (_a10 = record.target[ATTACHABLE_CONTROLLER]) == null ? void 0 : _a10.hostConnected();
    }
  });
}
  ...
  handleEvent(event) {
    ...
    switch (event.type) {
      default:
        return;
      case "focusin":
        this.visible = ((_a10 = this.control) == null ? void 0 : _a10.matches(":focus-visible")) ?? false;
        break;
      case "focusout":
      case "pointerdown":
        this.visible = false;
...
var ClassMapDirective = class extends Directive {
  constructor(partInfo) {
    var _a10;
    super(partInfo);
    if (partInfo.type !== PartType.ATTRIBUTE || partInfo.name !== "class" || ((_a10 = partInfo.strings) == null ? void 0 : _a10.length) > 2) {
  ...
  update(part, [classInfo]) {
    ...
    if (this._previousClasses === void 0) {
      ...
      for (const name in classInfo) {
        if (classInfo[name] && !((_a10 = this._staticClasses) == null ? void 0 : _a10.has(name))) {
...
var Ripple = class extends LitElement {
  ...
  startPressAnimation(positionEvent) {
    ...
    this.pressed = true;
    (_a10 = this.growAnimation) == null ? void 0 : _a10.cancel();
...
function polyfillElementInternalsAria(host, internals2) {
  ...
  host.addController({
    hostConnected() {
      ...
      for (const { property: property2 } of firstConnectedCallbacks) {
        const wasSetByUser = host.getAttribute(ariaPropertyToAttribute(property2)) !== null || // Dynamic lookup rather than hardcoding all properties.
        // tslint:disable-next-line:no-dict-access-on-struct-type
        host[property2] !== void 0;
        if (wasSetByUser) {
          propertiesSetByUser.add(property2);
        }
      }
      for (const { property: property2, callback } of firstConnectedCallbacks) {
        if (propertiesSetByUser.has(property2)) {
          continue;
        }
        callback();
      }
...
var Button = class extends LitElement {
  ...
  focus() {
    var _a10;
    (_a10 = this.buttonElement) == null ? void 0 : _a10.focus();
  }
  blur() {
    var _a10;
    (_a10 = this.buttonElement) == null ? void 0 : _a10.blur();
  }
  render() {
  ...
  renderContent() {
    ...
    return html`
      ${(_a10 = this.renderElevation) == null ? void 0 : _a10.call(this)}
      ${(_b3 = this.renderOutline) == null ? void 0 : _b3.call(this)}
...
var MultiActionChip = class extends Chip {
  ...
  handleKeyDown(event) {
    ...
    const isPrimaryFocused = (_a10 = this.primaryAction) == null ? void 0 : _a10.matches(":focus-within");
...
var styles20 = css`:host{--_color: var(--md-divider-color, var(--md-sys-color-outline-variant, #cac4d0));--_thickness: var(--md-divider-thickness, 1px);box-sizing:border-box;color:var(--_color);display:flex;height:var(--_thickness);width:100%}:host([inset]),:host([inset-start]){padding-inline-start:16px}:host([inset]),:host([inset-end]){padding-inline-end:16px}:host::before{background:currentColor;content:"";height:100%;width:100%}@media(forced-colors: active){:host::before{background:CanvasText}}/*# sourceMappingURL=divider-styles.css.map */
`;

// node_modules/@material/web/divider/divider.js
var MdDivider = class MdDivider2 extends Divider {
};
MdDivider.styles = [styles20];
...
var Dialog = class extends LitElement {
  ...
  async show() {
    ...
    (_a10 = this.querySelector("[autofocus]")) == null ? void 0 : _a10.focus();
...
var Field = class extends LitElement {
  ...
  render() {
    ...
    const outline = (_a10 = this.renderOutline) == null ? void 0 : _a10.call(this, floatingLabel);
    const classes = {
      "disabled": this.disabled,
  ...
  animateLabelIfNeeded({ wasFocused, wasPopulated }) {
    ...
    (_a10 = this.labelAnimation) == null ? void 0 : _a10.cancel();
...
var _a5;
var IconButton = class extends LitElement {
  constructor() {
    super(...arguments);
    this.disabled = false;
...
var styles31 = css`:host{display:inline-flex;outline:none;-webkit-tap-highlight-color:rgba(0,0,0,0);height:var(--_container-height);width:var(--_container-width);justify-content:center}:host([touch-target=wrapper]){margin:max(0px,(48px - var(--_container-height))/2) max(0px,(48px - var(--_container-width))/2)}md-focus-ring{--md-focus-ring-shape-start-start: var(--_container-shape-start-start);--md-focus-ring-shape-start-end: var(--_container-shape-start-end);--md-focus-ring-shape-end-end: var(--_container-shape-end-end);--md-focus-ring-shape-end-start: var(--_container-shape-end-start)}:host([disabled]){pointer-events:none}.icon-button{place-items:center;background:none;border:none;box-sizing:border-box;cursor:pointer;display:flex;place-content:center;outline:none;padding:0;position:relative;text-decoration:none;user-select:none;z-index:0;flex:1;border-start-start-radius:var(--_container-shape-start-start);border-start-end-radius:var(--_container-shape-start-end);border-end-start-radius:var(--_container-shape-end-start);border-end-end-radius:var(--_container-shape-end-end)}.icon ::slotted(*){font-size:var(--_icon-size);height:var(--_icon-size);width:var(--_icon-size);font-weight:inherit}md-ripple{z-index:-1;border-start-start-radius:var(--_container-shape-start-start);border-start-end-radius:var(--_container-shape-start-end);border-end-start-radius:var(--_container-shape-end-start);border-end-end-radius:var(--_container-shape-end-end)}.flip-icon .icon{transform:scaleX(-1)}.icon{display:inline-flex}.link{height:100%;outline:none;position:absolute;width:100%}.touch{position:absolute;height:max(48px,100%);width:max(48px,100%)}:host([touch-target=none]) .touch{display:none}@media(forced-colors: active){:host([disabled]){--_disabled-icon-opacity: 1}}/*# sourceMappingURL=shared-styles.css.map */
`;
...
MdFilledIconButton.styles = [styles31, styles30];
...
MdFilledTonalIconButton.styles = [styles31, styles32];
...
MdOutlinedIconButton.styles = [styles31, styles34];
...
var styles35 = css`:host{background:var(--md-list-container-color, var(--md-sys-color-surface, #fef7ff));color:unset;display:flex;flex-direction:column;outline:none;padding:8px 0;position:relative}/*# sourceMappingURL=list-styles.css.map */
`;

// node_modules/@material/web/list/list.js
var MdList = class MdList2 extends List {
};
MdList.styles = [styles35];
MdList = __decorate([
...
function slotHasContent(slot) {
  ...
  for (const node of slot.assignedNodes({ flatten: true })) {
    ...
    const isTextWithContent = node.nodeType === Node.TEXT_NODE && ((_a10 = node.textContent) == null ? void 0 : _a10.match(/\S/));
...
var ListItemEl = class extends LitElement {
  ...
  focus() {
    var _a10;
    (_a10 = this.listItemRoot) == null ? void 0 : _a10.focus();
  }
};
(() => {
...
var StyleMapDirective = class extends Directive {
  constructor(partInfo) {
    var _a10;
    super(partInfo);
    if (partInfo.type !== PartType.ATTRIBUTE || partInfo.name !== "style" || ((_a10 = partInfo.strings) == null ? void 0 : _a10.length) > 2) {
...
function getFocusedElement(activeDoc = document) {
  ...
  while (activeEl && ((_a10 = activeEl == null ? void 0 : activeEl.shadowRoot) == null ? void 0 : _a10.activeElement)) {
...
var Menu = class extends LitElement {
  ...
  constructor() {
    ...
    this.beforeClose = async () => {
      ...
      if (!this.skipRestoreFocus) {
        (_b3 = (_a10 = this.lastFocusedElement) == null ? void 0 : _a10.focus) == null ? void 0 : _b3.call(_a10);
      }
      if (!this.quick) {
  ...
  close() {
    ...
    maybeSubmenu.forEach((item) => {
      var _a10;
      (_a10 = item.close) == null ? void 0 : _a10.call(item);
    });
  }
  show() {
    this.open = true;
...
var SubMenu = class extends LitElement {
  ...
  constructor() {
    ...
    this.onMouseenter = () => {
      ...
      if ((_a10 = this.menu) == null ? void 0 : _a10.open)
        return;
  ...
  onSlotchange() {
    ...
    this.item.ariaExpanded = "false";
    this.item.ariaHasPopup = "menu";
    if ((_a10 = this.menu) == null ? void 0 : _a10.id) {
  ...
  async onSubMenuKeydown(event) {
    ...
    (_a10 = this.item) == null ? void 0 : _a10.focus();
...
var styles40 = css`:host{position:relative;display:flex;flex-direction:column}/*# sourceMappingURL=sub-menu-styles.css.map */
`;

// node_modules/@material/web/menu/sub-menu.js
var MdSubMenu = class MdSubMenu2 extends SubMenu {
};
MdSubMenu.styles = styles40;
...
MdCircularProgress.styles = [styles41];
...
var Radio = class extends LitElement {
  ...
  set checked(checked) {
    ...
    const state2 = String(checked);
    this.internals.setFormValue(this.checked ? this.value : null, state2);
...
var Select = class extends LitElement {
  ...
  get options() {
    var _a10;
    return ((_a10 = this.menu) == null ? void 0 : _a10.items) ?? [];
  }
  /**
  ...
  reportValidity() {
    ...
    if (prevMessage === this.getErrorText()) {
      (_a10 = this.field) == null ? void 0 : _a10.reannounceError();
    }
    return valid;
  }
  /**
  ...
  async firstUpdated(changed) {
    var _a10;
    await ((_a10 = this.menu) == null ? void 0 : _a10.updateComplete);
  ...
  handleKeydown(event) {
    ...
    if (isPrintableKey) {
      ...
      (_b3 = (_a10 = this.labelEl) == null ? void 0 : _a10.setAttribute) == null ? void 0 : _b3.call(_a10, "aria-live", "polite");
  ...
  async handleOpening(e) {
    var _a10, _b3, _c;
    (_b3 = (_a10 = this.labelEl) == null ? void 0 : _a10.removeAttribute) == null ? void 0 : _b3.call(_a10, "aria-live");
...
MdFilledSelect.styles = [styles46, styles45, styles44];
...
MdSelectOption.styles = [styles39];
...
var Slider = class extends LitElement {
  ...
  focus() {
    var _a10;
    (_a10 = this.inputEnd) == null ? void 0 : _a10.focus();
  }
  willUpdate(changed) {
    var _a10, _b3;
    this.renderValueStart = changed.has("valueStart") ? this.valueStart : (_a10 = this.inputStart) == null ? void 0 : _a10.valueAsNumber;
  ...
  updated(changed) {
    ...
    if (changed.has("range") || changed.has("renderValueStart") || changed.has("renderValueEnd") || this.isUpdatePending) {
      const startNub = (_a10 = this.handleStart) == null ? void 0 : _a10.querySelector(".handleNub");
...
var Switch = class extends LitElement {
  ...
  update(changed) {
    const state2 = String(this.selected);
    this.internals.setFormValue(this.selected ? this.value : null, state2);
    super.update(changed);
  }
  render() {
    return html`
...
var Tab = class extends LitElement {
  ...
  [(_a8 = INDICATOR, ANIMATE_INDICATOR)](previousTab) {
    if (!this[INDICATOR]) {
      return;
    }
  ...
  getKeyframes(previousTab) {
    ...
    const from = {};
    const fromRect = ((_a10 = previousTab[INDICATOR]) == null ? void 0 : _a10.getBoundingClientRect()) ?? {};
...
var _a9, _b2;
var wrap2 = ENABLE_SHADYDOM_NOPATCH2 && ((_a9 = window.ShadyDOM) == null ? void 0 : _a9.inUse) && ((_b2 = window.ShadyDOM) == null ? void 0 : _b2.noPatch) === true ? window.ShadyDOM.wrap : (node) => node;
...
MdFilledTextField.styles = [styles58, styles57, styles56];
...
MdOutlinedTextField.styles = [styles58, styles60, styles59];
